...
var BusinessRoutes = []Route{
	...
	{"POST", "/v1/admin/registration-invites", "/auth.v1.AdminService/CreateRegistrationInvite", true, AuthHuman},
	{"POST", "/v1/admin/signing-keys/rotate", "/auth.v1.AdminService/RotateSigningKey", true, AuthHuman},
	{"GET", "/v1/admin/users", "/auth.v1.AdminService/ListUsers", false, AuthHuman},
	{"POST", "/v1/admin/users/{userID}/ban", "/auth.v1.AdminService/BanUser", true, AuthHuman},
	{"DELETE", "/v1/admin/users/{userID}/ban", "/auth.v1.AdminService/UnbanUser", true, AuthHuman},
	{"GET", "/v1/roles", "/auth.v1.RoleService/ListRoles", false, AuthHuman},
	{"POST", "/v1/roles", "/auth.v1.RoleService/CreateRole", false, AuthHuman},
	{"DELETE", "/v1/roles/{roleID}", "/auth.v1.RoleService/DeleteRole", false, AuthHuman},
	{"PATCH", "/v1/roles/{roleID}/description", "/auth.v1.RoleService/UpdateRoleDescription", false, AuthHuman},
	{"PATCH", "/v1/roles/{roleID}/parent", "/auth.v1.RoleService/SetRoleParent", false, AuthHuman},
	{"POST", "/v1/roles/{roleID}/mounts", "/auth.v1.RoleService/MountRole", false, AuthHuman},
	{"DELETE", "/v1/roles/{roleID}/mounts/{parentID}", "/auth.v1.RoleService/UnmountRole", false, AuthHuman},
	{"GET", "/v1/roles/{roleID}/subgroups", "/auth.v1.RoleService/ListSubgroups", false, AuthHuman},
	{"POST", "/v1/roles/{roleID}/tags", "/auth.v1.RoleService/AddRoleTag", true, AuthHuman},
	{"DELETE", "/v1/roles/{roleID}/tags", "/auth.v1.RoleService/DeleteRoleTag", true, AuthHuman},
	{"PATCH", "/v1/roles/{roleID}/tags", "/auth.v1.RoleService/RenameRoleTag", true, AuthHuman},
	{"GET", "/v1/users/{userID}/roles", "/auth.v1.RoleService/ListUserRoles", false, AuthHuman},
	{"GET", "/v1/roles/{roleID}/members", "/auth.v1.RoleService/ListRoleMembers", false, AuthHuman},
	{"POST", "/v1/roles/{roleID}/members", "/auth.v1.RoleService/AssignRole", false, AuthHuman},
	{"POST", "/v1/roles/{roleID}/members/{userID}/tags", "/auth.v1.RoleService/GrantMembershipTag", true, AuthHuman},
	{"DELETE", "/v1/roles/{roleID}/members/{userID}/tags", "/auth.v1.RoleService/RevokeMembershipTag", true, AuthHuman},
	{"DELETE", "/v1/roles/{roleID}/members/{userID}", "/auth.v1.RoleService/RemoveRole", false, AuthHuman},
	{"POST", "/v1/roles/{roleID}/requests", "/auth.v1.RoleService/RequestRole", false, AuthHuman},
	{"GET", "/v1/roles/{roleID}/requests", "/auth.v1.RoleService/ListRoleRequests", false, AuthHuman},
	{"POST", "/v1/role-requests/{requestID}/decide", "/auth.v1.RoleService/DecideRoleRequest", false, AuthHuman},
}
